               ...
               <nav className="flex-1 px-3 py-4 space-y-0.5 overflow-y-auto scrollbar-hide">
                  {links.map((link) => (
                     <Link
                        ...
                        className={`flex items-center gap-3 px-4 py-2.5 rounded text-sm font-medium transition-colors ${location.pathname === link.path || location.pathname.startsWith(`${link.path}/`)
               ...
               <div className="p-4 border-t border-slate-100">
                  <div className="flex items-center gap-3 mb-3 px-2">
                     ...
                     <div className="min-w-0">
                        ...
                        <p className="text-[10px] font-medium text-slate-400 ">Hub Ops</p>
                     </div>
                  </div>
                  <button
                     onClick={logout}
               ...
               <div className="flex items-center gap-4 flex-1">
                  ...
                  <div className="flex items-center gap-3 flex-1">
                     <div className="flex items-center gap-2 px-3 py-1 bg-green-50 border border-green-100 rounded">
                        ...
                        <span className="text-[10px] font-bold text-green-700  tracking-tight">Active</span>
                     </div>
      ...
      <div className="relative">
         ...
         >
            ...
            <div className="text-left hidden sm:block">
               <p className="text-[10px] font-black text-slate-400  tracking-widest leading-none mb-0.5">Tactical Node</p>
         ...
         {open && (
            <div className="absolute top-full left-0 mt-2 w-64 bg-white border border-slate-200 rounded-xl shadow-2xl z-[100] overflow-hidden animate-in zoom-in-95 duration-200">
               <div className="p-3 bg-slate-50 border-b border-slate-200 flex items-center justify-between">
                  <span className="text-[10px] font-black text-slate-500  tracking-widest">Available Nodes</span>
               ...
               <div className="max-h-64 overflow-y-auto no-scrollbar py-1">
                  {hubs.map(h => (
                     ...
                     >
                        <div>
                           <p className="text-xs font-black text-slate-900  tracking-tight">{h.name}</p>
                           <p className="text-[10px] font-bold text-slate-400 ">{h.town}, {h.county}</p>
                        </div>
                  ...
                  {hubs.length === 0 && !loading && (
                     <div className="p-8 text-center opacity-30">
                        ...
                        <p className="text-[10px] font-black  tracking-widest">No nodes found</p>
                     </div>
                  )}
               </div>
            </div>
