      ...
      <div className="space-y-6 animate-in fade-in duration-500">
         ...
         <div className="flex flex-col md:flex-row md:items-end justify-between border-b border-slate-200 pb-6 gap-6">
            <div>
               <button
                  onClick={() => navigate(-1)}
                  className="flex items-center gap-2 text-slate-400 hover:text-slate-900 transition-colors text-[10px] font-black  tracking-widest mb-4"
               >
            ...
            <div className="flex gap-2">
               <button
                  onClick={fetchLogs}
                  className="px-6 py-3 bg-slate-900 text-white rounded-lg text-[10px] font-black hover:bg-slate-800 transition-all shadow-xl shadow-slate-200  tracking-widest flex items-center gap-3"
               >
         ...
         <div className="bg-white border border-slate-200 rounded-xl p-4 flex flex-col md:flex-row gap-4 shadow-sm">
            <div className="flex-1 relative">
               ...
               <input
                  ...
                  className="w-full pl-10 pr-4 py-2.5 bg-slate-50 border border-slate-200 rounded text-xs font-bold outline-none focus:bg-white focus:border-slate-900 transition-all  tracking-tight"
               />
            </div>
            <div className="flex items-center gap-2">
               ...
               <select
                  ...
                  className="border border-slate-200 rounded px-4 py-2.5 text-xs font-black outline-none focus:border-slate-900 bg-slate-50  tracking-widest"
               >
         ...
         <div className="bg-white border border-slate-200 rounded-2xl shadow-sm overflow-hidden min-h-[500px]">
            {loading ? (
               <div className="flex flex-col items-center justify-center p-40 opacity-50">
                  ...
                  <span className="text-xs font-bold  tracking-widest text-slate-500 tracking-[0.2em]">Accessing Node Audit Vault...</span>
               </div>
                        ...
                        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                           <div className="flex gap-5">
                              ...
                              <div>
                                 ...
                                 <p className="text-[11px] font-bold text-slate-500  leading-relaxed max-w-2xl">{log.message}</p>
                              </div>
                           </div>
                           <div className="md:text-right shrink-0 flex flex-row md:flex-col items-center md:items-end gap-3 md:gap-1 pl-16 md:pl-0">
                              ...
                              <div className="flex items-center gap-1.5 text-slate-400 text-[10px] font-bold  tracking-tighter">
                                 <Calendar size={12} />
               ...
               <div className="flex flex-col items-center justify-center py-40 opacity-30 text-center px-8">
                  ...
                  <p className="text-sm font-black  tracking-[0.2em] text-slate-400">Node Audit Gap</p>
                  <p className="text-xs font-bold text-slate-400 mt-2 italic max-w-xs ">No operational events detected for the current filter selection or node status.</p>
               </div>
            )}
         </div>
         ...
         <div className="flex items-center justify-between px-6 py-4 bg-slate-900 rounded-xl text-white shadow-xl">
            <div className="flex items-center gap-3">
               ...
               <span className="text-[9px] font-black  tracking-widest text-slate-400">Real-time Telemetry Enabled</span>
            </div>
            <p className="text-[9px] font-bold text-slate-500 ">Unified Logistics Ledger · v4.0.2-STABLE</p>
         </div>
      </div>
   );
};
