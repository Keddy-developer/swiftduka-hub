...
export default function RegisterSeller() {
    ...
    if (fetching) return (
      <div className="flex flex-col items-center justify-center p-20 opacity-50">
        ...
        <span className="text-xs font-bold uppercase tracking-widest text-slate-500">Retrieving Merchant Identity...</span>
      </div>
    );
    ...
    return (
        <div className="max-w-6xl mx-auto space-y-6 md:space-y-10 animate-in fade-in duration-500 pb-20">
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between border-b border-slate-200 pb-6 gap-6">
                <div>
                  <button onClick={() => navigate('/sellers')} className="flex items-center gap-2 text-[10px] font-black text-slate-400 uppercase tracking-widest hover:text-slate-900 transition-colors mb-4 group">
                  ...
                  <div className="flex items-center gap-3 mt-1">
                     ...
                     <span className="text-[10px] font-black text-slate-400 uppercase tracking-tighter">Status: Security Screening</span>
                  </div>
                </div>
                ...
                <div className="lg:col-span-8 space-y-6 md:space-y-8">
                    ...
                    <section className="bg-white border border-slate-200 rounded-2xl shadow-sm overflow-hidden group">
                        <div className="px-6 py-4 bg-slate-50 border-b border-slate-200 flex items-center gap-3">
                            ...
                            <h3 className="text-xs font-black text-slate-900 uppercase tracking-widest">Merchant Identity & Brand Profile</h3>
                        </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <select name="seller_type" value={form.seller_type} onChange={handleChange} required
                                      className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 text-xs font-black outline-none focus:border-slate-900 focus:bg-white shadow-sm transition-all uppercase">
                    ...
                    <section className="bg-white border border-slate-200 rounded-2xl shadow-sm overflow-hidden group">
                        <div className="px-6 py-4 bg-slate-50 border-b border-slate-200 flex items-center gap-3">
                            ...
                            <h3 className="text-xs font-black text-slate-900 uppercase tracking-widest">Logistics Operational Center</h3>
                        </div>
                        <div className="p-6 md:p-8 space-y-8">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
                                <div className="space-y-2">
                                    <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1">Regional Strategic County</label>
                                ...
                                <div className="space-y-2">
                                    <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1">Logistics Primary City</label>
                    ...
                    <section className="bg-slate-900 text-white rounded-2xl shadow-xl overflow-hidden group">
                        <div className="px-6 py-4 bg-white/5 border-b border-white/10 flex items-center gap-3">
                            ...
                            <h3 className="text-xs font-black uppercase tracking-widest">Merchant Strategic Dossier</h3>
                        </div>
                        <div className="p-6 md:p-8">
                            ...
                            <div className="mt-4 flex items-center justify-between">
                               ...
                               <p className="text-[9px] font-black text-slate-500 uppercase tracking-widest">Min: 50 Chars</p>
                            </div>
                        </div>
                    </section>
                </div>
                ...
                <div className="lg:col-span-4 space-y-6 md:space-y-8">
                    ...
                    <section className="bg-white border border-slate-200 rounded-2xl shadow-sm overflow-hidden shadow-xl shadow-slate-200/20">
                        <div className="px-6 py-4 bg-slate-50 border-b border-slate-200 flex items-center gap-3">
                            ...
                            <h3 className="text-xs font-black text-slate-900 uppercase tracking-widest">Financial Settlement Protocol</h3>
                        </div>
                        <div className="p-6 space-y-8">
                            <div className="space-y-3">
                               <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1">Settlement Gateway Protocol</label>
                               <div className="grid grid-cols-2 gap-2">
                                  <button type="button" onClick={() => setForm({...form, paymentMethod: 'MPESA'})}
                                    className={`py-3 rounded-xl text-[10px] font-black uppercase tracking-widest border transition-all ${form.paymentMethod === 'MPESA' ? 'bg-slate-900 text-white border-slate-900' : 'bg-slate-50 text-slate-400 border-slate-200 hover:border-slate-400'}`}>
                                    M-Pesa ID
                                  </button>
                                  <button type="button" onClick={() => setForm({...form, paymentMethod: 'BANK'})}
                                    className={`py-3 rounded-xl text-[10px] font-black uppercase tracking-widest border transition-all ${form.paymentMethod === 'BANK' ? 'bg-slate-900 text-white border-slate-900' : 'bg-slate-50 text-slate-400 border-slate-200 hover:border-slate-400'}`}>
                                    Bank EFT
                                  </button>
                               </div>
                            </div>
                    ...
                    <section className="bg-gradient-to-br from-blue-50 to-white border border-blue-100 rounded-2xl p-6 space-y-6 relative overflow-hidden group">
                        <div className="flex items-center gap-3 mb-2 relative z-10">
                           ...
                           <h4 className="text-[10px] font-black text-blue-900 uppercase tracking-widest">Global Compliance Registry</h4>
                        </div>
