        ...
        <form onSubmit={handleSearch} className="flex max-w-2xl gap-3">
          <div className="relative flex-1">
            ...
            <input
              ...
              className="w-full pl-12 pr-4 py-3 bg-slate-50 border border-slate-200 rounded-xl focus:bg-white focus:border-blue-500 focus:ring-4 focus:ring-blue-50 transition-all text-slate-900 font-bold uppercase tracking-widest placeholder:normal-case placeholder:font-normal"
              disabled={loading}
            />
          </div>
          <button
          ...
          <div className="bg-white border border-slate-200 rounded-2xl overflow-hidden shadow-sm">
             <div className="px-6 py-4 border-b border-slate-100 bg-slate-50 flex flex-wrap items-center justify-between gap-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                     <p className="text-xs font-bold text-slate-400 tracking-widest uppercase">Tracking Record</p>
                ...
                <div className="flex gap-2">
                   ...
                   <div className="px-3 py-1 bg-green-50 border border-green-200 rounded-lg flex items-center gap-2">
                      ...
                      <span className="text-xs font-black text-green-700 uppercase tracking-tight">Affiliated</span>
                   </div>
                </div>
             </div>
             ...
             <div className="grid grid-cols-1 md:grid-cols-2 p-6 gap-6">
                <div>
                   <h3 className="text-xs font-black text-slate-400 uppercase tracking-widest mb-3">Customer Profile</h3>
                ...
                <div className="p-4 bg-slate-50 border border-slate-100 rounded-xl">
                   <h3 className="text-xs font-black text-slate-400 uppercase tracking-widest mb-3 flex items-center gap-1.5"><Truck className="w-3.5 h-3.5" /> Destination Routing</h3>
                      ...
                      <div className="flex flex-wrap items-start justify-between gap-4">
                         <div>
                            <div className="flex gap-2 items-center mb-1">
                               <span className="px-2 py-0.5 bg-blue-50 text-blue-700 font-bold text-[10px] uppercase rounded">{item.deliveryStatus}</span>
                               <span className="px-2 py-0.5 bg-slate-100 text-slate-600 font-bold text-[10px] uppercase rounded">Qty: {item.quantity}</span>
                            </div>
                         ...
                         {item.riderOrders && item.riderOrders.length > 0 && (
                            <div className="p-3 bg-purple-50 border border-purple-100 rounded-xl text-sm min-w-48 text-right">
                               <p className="text-[10px] font-black text-purple-600 uppercase tracking-widest mb-1">Assigned Rider</p>
