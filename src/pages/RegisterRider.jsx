...
export default function RegisterRider() {
  ...
  if (fetching) return (
    <div className="flex flex-col items-center justify-center p-20 opacity-50">
      ...
      <span className="text-xs font-bold  tracking-widest text-slate-500">Retrieving Agent Credentials...</span>
    </div>
  );
  ...
  return (
    <div className="max-w-5xl mx-auto space-y-6 md:space-y-10 animate-in fade-in duration-500 pb-20">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between border-b border-slate-200 pb-6 gap-6">
        <div>
          <button onClick={() => navigate('/fleet')} className="flex items-center gap-2 text-[10px] font-black text-slate-400  tracking-widest hover:text-slate-900 transition-colors mb-4 group">
          ...
          <div className="flex items-center gap-3 mt-1">
            ...
            <span className="text-[10px] font-black text-slate-400  tracking-tighter">Status: Vetting Pipeline</span>
          </div>
        </div>
      </div>
        ...
        <div className="lg:col-span-8 space-y-8">
          ...
          <section className="bg-white border border-slate-200 rounded-2xl shadow-sm overflow-hidden group">
            <div className="px-6 py-4 bg-slate-50 border-b border-slate-200 flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <h3 className="text-xs font-black text-slate-900  tracking-widest">Personnel Legal Identity</h3>
              </div>
            ...
            <div className="p-6 md:p-8 space-y-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <InputUnit label="DL Authority Identifier" name="drivingLicence" value={form.drivingLicence} onChange={handleChange} required icon={ShieldCheck} />
              ...
              {!hub?.id && (
                <div className="grid grid-cols-1 gap-8 pt-4 border-t border-slate-100">
                  <div className="space-y-2">
                    <label className="text-[10px] font-black text-rose-500  tracking-widest ml-1 flex items-center gap-2">
          ...
          <section className="bg-white border border-slate-200 rounded-2xl shadow-sm overflow-hidden group">
            <div className="px-6 py-4 bg-slate-50 border-b border-slate-200 flex items-center gap-3">
              ...
              <h3 className="text-xs font-black text-slate-900  tracking-widest">Logistics Asset Parameters</h3>
            </div>
            <div className="p-6 md:p-8 space-y-8">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
                <div className="space-y-2">
                  ...
                  <select name="vehicleType" value={form.vehicleType} onChange={handleChange} required
                    className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3.5 text-xs font-black outline-none focus:border-slate-900 focus:bg-white shadow-sm transition-all ">
                ...
                <InputUnit label="Federal Number Plate" name="numberPlate" value={form.numberPlate} onChange={handleChange} required icon={IdCard} />
        ...
        <div className="lg:col-span-4 space-y-8">
          ...
          <section className="bg-white border border-slate-200 rounded-2xl shadow-sm overflow-hidden group shadow-xl shadow-slate-200/20">
            <div className="px-6 py-4 bg-slate-50 border-b border-slate-200 flex items-center gap-3">
              ...
              <h3 className="text-xs font-black text-slate-900  tracking-widest">Visual Asset Certification</h3>
            </div>
            <div className="p-6 space-y-6">
                ...
                <div className="border-4 border-dashed border-slate-100 rounded-2xl p-2 text-center hover:border-slate-300 transition-all bg-slate-50 group-hover:bg-white relative overflow-hidden aspect-video flex flex-col items-center justify-center shadow-inner">
                  {form.vehicleImage || existingImage ? (
                    ...
                    <div className="space-y-3 opacity-20 group-hover:opacity-100 transition-all transform group-hover:scale-110 duration-500">
                      ...
                      <p className="text-[10px] font-black tracking-[0.2em] text-slate-900">Upload Asset Telemetry Photo</p>
                    </div>
                  )}
                  <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 flex items-center justify-center transition-opacity">
                    <p className="text-xs font-black text-white tracking-widest">Update Asset Media</p>
                  </div>
              ...
              <div className="bg-slate-900 text-white p-6 rounded-2xl shadow-2xl relative overflow-hidden">
                <div className="flex items-center gap-3 mb-4 relative z-10">
                  ...
                  <h5 className="text-[10px] font-black tracking-widest underline decoration-blue-500 underline-offset-4">Security Protocol</h5>
                </div>
                <p className="text-[10px] text-slate-400 leading-relaxed font-black opacity-80 relative z-10 italic">
          ...
          <div className="bg-gradient-to-br from-blue-50 to-white border border-blue-100 rounded-2xl p-6 flex gap-4 items-start shadow-sm">
            ...
            <div className="space-y-1">
              <p className="text-[10px] font-black text-blue-900  tracking-widest leading-none">Node Sync Notice</p>
              <p className="text-[10px] text-blue-700 font-bold leading-relaxed  tracking-tight italic opacity-70">New agents are synchronized across the regional mesh network within 5 operational minutes.</p>
            </div>
          </div>
