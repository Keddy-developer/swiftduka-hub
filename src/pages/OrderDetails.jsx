                        ...
                        <div className="p-6 border-b border-gray-100 bg-gray-50/50">
                            <div className="flex items-center justify-between">
                                <div>
                                    ...
                                    {isSupport && (
                                        <div className="inline-flex items-center gap-1.5 px-2 py-0.5 rounded-full text-[10px] font-bold bg-amber-100 text-amber-700 border border-amber-200 uppercase tracking-wider mt-1 mb-2">
                                    ...
                                    <div key={index} className="p-6 hover:bg-gray-50 transition-colors">
                                        <div className="flex flex-col gap-4">
                                            ...
                                            <div className="flex flex-wrap gap-2 justify-end mt-2">
                                                {isSupport && (
                                                    <span className="text-[10px] text-amber-600 font-bold uppercase tracking-tight py-1">Limited Support Mode</span>
                                                )}
                                                ...
                                                {product.adminReceived && order.pickUpStation?.isPickupStation && product.deliveryStatus !== "ReadyForPickup" && product.deliveryStatus !== "Delivered" && product.deliveryStatus !== "Cancelled" && product.deliveryType !== "NATIONWIDE" && !isSupport && (
                                                    <ActionButton
                                                ...
                                                {/* Mark Received */}
                                                {product.deliveryStatus === "ReadyForLogistics" && !product.adminReceived && !isSupport && (
                                                    <ActionButton
                                                ...
                                                {/* Cancel Product */}
                                                {product.deliveryStatus !== "Delivered" && product.deliveryStatus !== "Cancelled" && !isSupport && (
                                                    <ActionButton
