        ...
        <div className="min-h-screen bg-slate-50 flex flex-col items-center justify-center p-4">
            <div className="w-full max-w-sm space-y-8">
                ...
                <div className="text-center space-y-2">
                    ...
                    <h1 className="text-2xl font-black text-slate-900 tracking-tighter  whitespace-nowrap">HUB OPERATIONAL PORTAL</h1>
                    <p className="text-[10px] font-bold text-slate-400  tracking-widest leading-none">Restricted Fulfillment Infrastructure Access</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="bg-white border border-slate-200 rounded shadow-sm overflow-hidden p-6 space-y-6">
                    <div className="space-y-4">
                        <div className="space-y-1">
                            <label className="text-[9px] font-bold text-slate-400  ml-1">Staff Identifier</label>
                        ...
                        <div className="space-y-1">
                            <label className="text-[9px] font-bold text-slate-400  ml-1">Security Passphrase</label>
                            <div className="relative group">
                    ...
                    <div className="flex items-center justify-between">
                        <label className="flex items-center gap-2 cursor-pointer group">
                            ...
                            <span className="text-[10px] font-bold text-slate-400 group-hover:text-slate-900 ">Remember Station</span>
                        </label>
                        <button type="button" onClick={() => setShowAccessModal(true)} className="text-[10px] font-bold text-slate-900 hover:underline ">Access Issue?</button>
                    </div>

                    <button
                        type="submit" disabled={loading}
                        className="w-full py-3 bg-slate-900 text-white rounded text-[11px] font-black  tracking-widest hover:bg-slate-800 transition-all shadow-xl shadow-slate-200 flex items-center justify-center gap-2"
                    >
                ...
                <div className="flex flex-col items-center gap-4 pt-4 border-t border-slate-100">
                    <div className="flex items-center gap-2 px-3 py-1 bg-slate-100 rounded-full border border-slate-200">
                        ...
                        <span className="text-[9px] font-bold text-slate-500  tracking-widest">Protocol: Cloud-Alpha-Ready</span>
                    </div>
                    <p className="text-[9px] font-bold text-slate-300  tracking-widest">© 2026 ikoSoko Logistics Engineering</p>
                </div>
            </div>
            ...
            {showAccessModal && (
                <div className="fixed inset-0 bg-black/40 backdrop-blur-[1px] flex items-center justify-center z-50 p-4">
                    <div className="bg-white border border-slate-200 rounded shadow-2xl w-full max-w-xs p-6 space-y-4 animate-in zoom-in duration-200 text-center">
                        ...
                        <div className="space-y-1">
                            <h3 className="text-sm font-bold text-slate-900  tracking-tight">Security Restriction</h3>
                        ...
                        <div className="p-4 bg-slate-50 border border-slate-100 rounded text-left space-y-2">
                            <div className="flex items-center gap-2 text-[10px] font-bold text-slate-700 "><Phone size={12} className="text-slate-400" /> +254 700 000 000</div>
                            <div className="flex items-center gap-2 text-[10px] font-bold text-slate-700 "><Mail size={12} className="text-slate-400" /> support@ikosoko.com</div>
                        </div>
                        <button onClick={() => setShowAccessModal(false)} className="w-full py-2.5 bg-slate-900 text-white rounded text-[10px] font-bold  tracking-widest">ACKNOWLEDGEMENT RECEIVED</button>
                    </div>
                </div>
            )}
        </div>
