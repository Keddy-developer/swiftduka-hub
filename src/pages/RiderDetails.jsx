            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 md:gap-8 items-start">
                ...
                <div className="lg:col-span-4 space-y-6">
                    <section className="bg-slate-900 rounded border border-slate-800 p-6 text-white shadow-lg relative overflow-hidden group text-center">
                        ...
                        <p className="text-[10px] font-bold text-slate-400 tracking-widest mt-1">Personnel ID: {rider.id?.slice(0, 8)}</p>

                        <div className="mt-6 flex flex-wrap gap-2 justify-center">
                            <span className="px-2 py-0.5 bg-white/10 border border-white/20 rounded text-[9px] font-bold tracking-widest text-slate-300">Rider Class-A</span>
                            <span className="px-2 py-0.5 bg-white/10 border border-white/20 rounded text-[9px] font-bold tracking-widest text-slate-300">Hub Verified</span>
                        </div>
                    </section>
                    ...
                    <section className="bg-white border border-slate-200 rounded shadow-sm overflow-hidden min-h-[400px]">
                        ...
                        <div className="p-6">
                            ...
                            <div className="mt-8 border-t border-slate-100 pt-8">
                                <h4 className="text-[10px] font-bold text-slate-400 tracking-widest mb-4">Account Utility</h4>
                                <div className="flex flex-wrap gap-2">
                                    <button className="p-2 px-6 bg-slate-900 text-white rounded text-[10px] font-bold hover:bg-slate-800 transition-all shadow-sm">Personnel Audit</button>
                            ...
                            <div className="mt-8 p-6 bg-amber-50 border border-amber-100 rounded flex gap-4 items-start">
                                ...
                                <div className="space-y-1">
                                    <h5 className="text-[11px] font-bold text-amber-900 tracking-tight">Security Protocol Advisory</h5>
